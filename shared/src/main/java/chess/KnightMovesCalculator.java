...
public class KnightMovesCalculator implements PieceMovesCalculator{
    ...
    public Collection<ChessMove> pieceMoves(ChessBoard board, ChessPosition myPosition) {
        ...
        if (rowIndex - 2 > -1 && colIndex - 1 > -1 && (board.getBoard()[rowIndex - 2][colIndex - 1] == null
                || board.getBoard()[rowIndex - 2][colIndex - 1].getTeamColor() != color)) {
            moves.add(new ChessMove(myPosition, new ChessPosition(rowIndex - 1, colIndex), null));
        }
        if (rowIndex - 2 > -1 && colIndex + 1 < 8 && (board.getBoard()[rowIndex - 2][colIndex + 1] == null
                || board.getBoard()[rowIndex - 2][colIndex + 1].getTeamColor() != color)) {
            moves.add(new ChessMove(myPosition, new ChessPosition(rowIndex - 1, colIndex + 2), null));
        }
        if (rowIndex - 1 > -1 && colIndex + 2 < 8 && (board.getBoard()[rowIndex - 1][colIndex + 2] == null
                || board.getBoard()[rowIndex - 1][colIndex + 2].getTeamColor() != color)) {
            moves.add(new ChessMove(myPosition, new ChessPosition(rowIndex, colIndex + 3), null));
        }
        if (rowIndex + 1 < 8 && colIndex + 2 < 8 && (board.getBoard()[rowIndex + 1][colIndex + 2] == null
                || board.getBoard()[rowIndex + 1][colIndex + 2].getTeamColor() != color)) {
            moves.add(new ChessMove(myPosition, new ChessPosition(rowIndex + 2, colIndex + 3), null));
        }
        if (rowIndex + 2 < 8 && colIndex + 1 < 8 && (board.getBoard()[rowIndex + 2][colIndex + 1] == null
                || board.getBoard()[rowIndex + 2][colIndex + 1].getTeamColor() != color)) {
            moves.add(new ChessMove(myPosition, new ChessPosition(rowIndex + 3, colIndex + 2), null));
        }
        if (rowIndex + 2 < 8 && colIndex - 1 > -1 && (board.getBoard()[rowIndex + 2][colIndex - 1] == null
                || board.getBoard()[rowIndex + 2][colIndex - 1].getTeamColor() != color)) {
            moves.add(new ChessMove(myPosition, new ChessPosition(rowIndex + 3, colIndex), null));
        }
        if (rowIndex + 1 < 8 && colIndex - 2 > -1 && (board.getBoard()[rowIndex + 1][colIndex - 2] == null
                || board.getBoard()[rowIndex + 1][colIndex - 2].getTeamColor() != color)) {
            moves.add(new ChessMove(myPosition, new ChessPosition(rowIndex + 2, colIndex - 1), null));
        }
        if (rowIndex - 1 > -1 && colIndex - 2 > -1 && (board.getBoard()[rowIndex - 1][colIndex - 2] == null
                || board.getBoard()[rowIndex - 1][colIndex - 2].getTeamColor() != color)) {
